...
using namespace leetcode::minimummovestomoveaboxtotheirtargetlocation;
...
int main(int /*argc*/, const char** argv) {
  ...
  TestCase<EmptyParser, VectorParser<VectorParser<CharParser>>> parse;
  ...
  try {
    while (it != next_token.end()) {
      ...
      std::cout << "expected:\n";
      std::cout << std::apply(
                       leetcode::minimummovestomoveaboxtotheirtargetlocation::standard::Solve,
                       input)
                << "\n";

      std::cout << "ouput:\n";
      std::cout << std::apply(leetcode::minimummovestomoveaboxtotheirtargetlocation::Solve, input)
                << "\n";
    }
