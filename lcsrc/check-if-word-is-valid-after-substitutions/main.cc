...
using namespace leetcode::checkifwordisvalidaftersubstitutions;
...
int main(int /*argc*/, const char** argv) {
  ...
  try {
    while (it != next_token.end()) {
      ...
      std::cout << "expected:\n";
      std::cout << std::apply(
                       leetcode::checkifwordisvalidaftersubstitutions::standard::Solve, input)
                << "\n";

      std::cout << "ouput:\n";
      std::cout << std::apply(leetcode::checkifwordisvalidaftersubstitutions::Solve, input) << "\n";
    }
