...
struct CopyTest {
  CopyTest() { std::cout << "Default Construct\n"; }
  CopyTest(const CopyTest& /**/) { std::cout << "Construct Copy\n"; }
  CopyTest(CopyTest&& /**/) noexcept { std::cout << "Construct Move\n"; }

  CopyTest& operator=(const CopyTest& /**/) {
    std::cout << "=Copy\n";
    return *this;
  }
  CopyTest& operator=(CopyTest&& /**/) noexcept {
    std::cout << "=Move\n";
    return *this;
  }
};
