...
using namespace leetcode::fillingbookcaseshelves;
...
int main(int /*argc*/, const char** argv) {
  ...
  try {
    while (it != next_token.end()) {
      ...
      std::cout << "expected:\n";
      std::cout << std::apply(leetcode::fillingbookcaseshelves::standard::Solve, input) << "\n";

      std::cout << "ouput:\n";
      std::cout << std::apply(leetcode::fillingbookcaseshelves::Solve, input) << "\n";
    }
