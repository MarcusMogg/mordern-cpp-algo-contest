...
using namespace leetcode::deletenodesandreturnforest;
...
int main(int /*argc*/, const char** argv) {
  ...
  TestCase<EmptyParser, TreeParser<IntParser>, VectorParser<IntParser>> parse;
  ...
  try {
    while (it != next_token.end()) {
      ...
      std::cout << "expected:\n";
      std::cout << std::apply(leetcode::deletenodesandreturnforest::standard::Solve, input) << "\n";

      std::cout << "ouput:\n";
      std::cout << std::apply(leetcode::deletenodesandreturnforest::Solve, input) << "\n";
    }
