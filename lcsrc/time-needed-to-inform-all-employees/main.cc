...
using namespace leetcode::timeneededtoinformallemployees;
...
int main(int /*argc*/, const char** argv) {
  ...
  TestCase<EmptyParser, IntParser, IntParser, VectorParser<IntParser>, VectorParser<IntParser>>
      parse;
  ...
  try {
    while (it != next_token.end()) {
      ...
      std::cout << "expected:\n";
      std::cout << std::apply(leetcode::timeneededtoinformallemployees::standard::Solve, input)
                << "\n";

      std::cout << "ouput:\n";
      std::cout << std::apply(leetcode::timeneededtoinformallemployees::Solve, input) << "\n";
    }
