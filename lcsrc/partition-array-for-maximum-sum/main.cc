...
using namespace leetcode::partitionarrayformaximumsum;
...
int main(int /*argc*/, const char** argv) {
  ...
  try {
    while (it != next_token.end()) {
      ...
      std::cout << "expected:\n";
      std::cout << std::apply(leetcode::partitionarrayformaximumsum::standard::Solve, input)
                << "\n";

      std::cout << "ouput:\n";
      std::cout << std::apply(leetcode::partitionarrayformaximumsum::Solve, input) << "\n";
    }
